  ...
  return c.json([
    {
      ...
      chainId: 8453,
      title:
        "say something nice about someone on farcaster 💜",
      description:
...
app.openapi(
  ...
  (c) => {
    return c.json([
      ...
      {
        userAddress:
          "0xee0c0d565b483aaa02581841d071986e7dc00c82",
        bountyId: 332,
        chainId: 8453,
      ...
      {
        userAddress:
          "0x122b561df0fcbead160293125fd0bcea3416c2c0",
        bountyId: 332,
        chainId: 8453,
...
app.openapi(getBountyClaimsRoute, (c) => {
  return c.json([
    ...
    },
    {
      ...
      issuer:
        "0xc2b96fd7a6d5ee1cf775ea19e8ae6c852ec8db79",
      isAccepted: false,
      bountyId: 332,
      owner:
        "0xb502c5856f7244dccdd0264a541cc25675353d39",
